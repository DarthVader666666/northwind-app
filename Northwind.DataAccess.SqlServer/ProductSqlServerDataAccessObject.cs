    ...
    public sealed class ProductSqlServerDataAccessObject : IProductDataAccessObject, IDisposable
    {
        ...
        public int InsertProduct(ProductTransferObject product)
        {
            ...
            const string commandText =
                ...
                UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued) OUTPUT Inserted.ProductID
                VALUES (
                @productName,@supplierId, @categoryId, @quantityPerUnit, @unitPrice,
        ...
        public ProductTransferObject FindProduct(int productId)
        {
            ...
            const string commandText =
                ...
                p.UnitPrice, p.UnitsInStock, p.UnitsOnOrder, p.ReorderLevel, p.Discontinued FROM dbo.Products as p
        ...
        public IAsyncEnumerable<ProductTransferObject> SelectProductsByName(ICollection<string> productNames)
        {
            ...
            p.UnitsInStock, p.UnitsOnOrder, p.ReorderLevel, p.Discontinued FROM dbo.Products as p
