...
namespace Northwind.DataAccess.Products
{
    ...
    public interface IProductCategoryDataAccessObject
    {
        ...
        IAsyncEnumerable<ProductCategoryTransferObject> SelectProductCategories(int offset, int limit);
        ...
        /// <returns>A <see cref="List{T}"/> of <see cref="ProductCategoryTransferObject"/>.</returns>
        IAsyncEnumerable<ProductCategoryTransferObject> SelectProductCategoriesByName(ICollection<string> productCategoryNames);
    }
}
