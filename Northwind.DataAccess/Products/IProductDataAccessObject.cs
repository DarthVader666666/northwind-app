...
namespace Northwind.DataAccess.Products
{
    ...
    public interface IProductDataAccessObject
    {
        ...
        IAsyncEnumerable<ProductTransferObject> SelectProductsByName(ICollection<string> productNames);
        ...
        IAsyncEnumerable<ProductTransferObject> SelectProductByCategory(ICollection<int> collectionOfCategoryId);
    }
}
